...
def cy_cen_find(data_in, radii, int d, # downbinning factor
                ...
                inputType='im',  # tells if input is an image or array of hits ('im', 'hit', or '3dhit')
    ...
    for ind, r in enumerate(radii):
        hough_temp, circle_temp, hax_temp = cy_hough_circle_trans(im_d, r, d, region, x, y, z, im_thresh, thickness, update)
